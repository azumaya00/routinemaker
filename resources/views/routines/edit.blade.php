    ...
    <main class="l-main l-main--base--sub">
        <div class="l-main__inner">
            <div class="p-list__container">
                <h2 class="p-list__title">{{__('Edit List')}}</h2>
            ...
            <div class="c-form__container">
                <form action="{{ route('routines.update', $routine->id) }}"
                      method="POST" class="c-form c-form--list">
                @csrf
                    ...
                    @for($i=1; $i<=10; $i++)
                        <label for="task{{$i - 1}}" class="c-form__label">
                            <input
                                ...
                                value="{{ old('task'.($i-1), $routine['task'.($i-1)] )}}"
